...
CREATE TABLE ORDER_LIST (
    ...
    PRICE BIGINT,
    TNO BIGINT,
    stage VARCHAR(26) DEFAULT '已送出訂單',
...
INSERT INTO MEMBER (MID, MNAME, ACCOUNT, PASSWORD, IDENTITY, EMAIL, PHONE, COUNTRY)
VALUES ('1', '王大明', 'MINGWANG', 'TEST', 'user', 'ming.wang@example.com', '0912000001', 'Taiwan');
INSERT INTO MEMBER (MID, MNAME, ACCOUNT, PASSWORD, IDENTITY, EMAIL, PHONE, COUNTRY)
VALUES ('2', '孫小美', 'MAY', 'TEST', 'user', 'sun.xiaomei@example.com', '0912000002', 'Taiwan');
INSERT INTO MEMBER (MID, MNAME, ACCOUNT, PASSWORD, IDENTITY, EMAIL, PHONE, COUNTRY)
VALUES ('3', '林大偉', 'WEILIN', 'TEST', 'user', 'lin.dawei@example.com', '0912000003', 'Taiwan');
INSERT INTO MEMBER (MID, MNAME, ACCOUNT, PASSWORD, IDENTITY, EMAIL, PHONE, COUNTRY)
VALUES ('4', '陳美環', 'MAYCHANG', 'TEST', 'user', 'chen.meihuan@example.com', '0912000004', 'Taiwan');
...
CREATE SEQUENCE REVIEW_RNO_SEQ
    START WITH 1
    INCREMENT BY 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
CREATE OR REPLACE FUNCTION SET_REVIEW_RNO() RETURNS TRIGGER AS $$
BEGIN
    IF NEW.RNO IS NULL THEN
        NEW.RNO := NEXTVAL('REVIEW_RNO_SEQ');
    END IF;
    RETURN NEW;
END;
$$ LANGUAGE PLPGSQL;
...
FOR EACH ROW
EXECUTE FUNCTION SET_REVIEW_RNO();

-- Insert sample data into REVIEW table
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (1, 'U58046', 5, '內容豐富，印刷品質佳，值得購買。', '2021-07-06 10:12:34');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (2, 'V00111', 4, '電影很好看，但包裝略有刮痕。', '2021-04-27 09:05:12');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (3, 'D11222', 3, '音質普通，價格合理。', '2021-05-31 18:22:45');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (4, 'B10234', 5, '教材實用、例題豐富，對學習很有幫助。', '2021-08-01 14:00:00');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (1, 'N41023', 2, '內容重複且編排雜亂，不太推薦。', '2021-09-15 11:11:11');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (2, 'B30771', 5, '超愛這張專輯，歌單很完整。', '2021-12-20 20:20:20');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (3, 'B20776', 4, '整體不錯，部份曲目感覺一般。', '2022-01-05 16:45:00');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (4, 'A12333', 5, '資訊安全講解清楚，實務案例實用。', '2022-02-11 08:30:00');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (1, 'V10889', 4, '故事引人入勝，但翻譯有些錯誤。', '2022-03-03 12:00:00');
INSERT INTO REVIEW (MID, PID, RATING, COMMENT, "DATE")
VALUES (2, 'F95191', 5, '小朋友很喜歡，重複播放也不膩。', '2022-04-10 09:09:09');

-- DDL for Table BROWSE
CREATE TABLE BROWSE (
    MID BIGINT,
    PID VARCHAR(26),
    BROESETIME TIMESTAMP,
    FOREIGN KEY (MID) REFERENCES MEMBER(MID),
    FOREIGN KEY (PID) REFERENCES PRODUCT(PID)
);

-- Insert sample data into BROWSE table
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (1, 'U58046', '2021-07-05 09:00:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (2, 'V00111', '2021-04-26 12:30:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (3, 'D11222', '2021-05-30 20:15:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (4, 'B10234', '2021-08-01 13:45:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (1, 'V10889', '2022-03-02 11:00:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (2, 'B30771', '2021-12-19 19:00:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (3, 'A12333', '2022-02-10 08:00:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (4, 'F95191', '2022-04-09 10:10:10');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (1, 'B40555', '2021-06-15 14:00:00');
INSERT INTO BROWSE (MID, PID, BROESETIME)
VALUES (2, 'N41023', '2021-09-14 16:16:16');